...
const controller = testerlib.PersonFieldsController;
...
describe("PersonFieldsController Tests", function tests() {
    this.timeout(testConfiguration.TEST_TIMEOUT);

    /**
     * Returns data about all person fields
     */
    it("should testTestGetAllPersonFields response", function testTestGetAllPersonFieldsTest(done) {
        controller.getAllPersonFields(function callback(error, response, context) {
            // test response code
     ...
     */
    it("should testTestAddANewPersonField response", function testTestAddANewPersonFieldTest(done) {
        // parameters for the API call
        let input = [];
        input['contentType'] = null;
        input['body'] = null;

        controller.addANewPersonField(input, function callback(error, response, context) {
            // test response code
            assert.equal(200, context.response.statusCode);
            done();
        }).catch(() => undefined);
