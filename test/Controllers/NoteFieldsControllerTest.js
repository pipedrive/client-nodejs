...
const controller = testerlib.NoteFieldsController;
...
describe("NoteFieldsController Tests", function tests() {
    this.timeout(testConfiguration.TEST_TIMEOUT);

    /**
     * Return list of all fields for note
     */
    it("should testTestGetAllFieldsForANote response", function testTestGetAllFieldsForANoteTest(done) {
        controller.getAllFieldsForANote(function callback(error, response, context) {
            // test response code
