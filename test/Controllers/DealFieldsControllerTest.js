...
const controller = testerlib.DealFieldsController;
...
describe("DealFieldsController Tests", function tests() {
    this.timeout(testConfiguration.TEST_TIMEOUT);

    /**
     * Returns data about all fields deals can have
     */
    it("should testTestGetAllDealFields response", function testTestGetAllDealFieldsTest(done) {
        // parameters for the API call
        let input = [];
        input['start'] = 0;
        input['limit'] = null;

        controller.getAllDealFields(input, function callback(error, response, context) {
            // test response code
     ...
     */
    it("should testTestAddANewDealField response", function testTestAddANewDealFieldTest(done) {
        // parameters for the API call
        let input = [];
        input['contentType'] = null;
        input['body'] = null;

        controller.addANewDealField(input, function callback(error, response, context) {
            // test response code
            assert.equal(200, context.response.statusCode);
            done();
        }).catch(() => undefined);
