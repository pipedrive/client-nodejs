...
export default class UsersApi {
    ...
    */
     ...
     * @param {String} address Email address to blacklist (can contain \\\\\\\\* for wildcards, e.g. \\\\\\\\*@example.com, or john\\\\\\\\*@ex\\\\\\\\*.com)
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Object} and HTTP response
     */
    addUserBlacklistedEmailWithHttpInfo(id, address) {
      const opts = {}
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling addUserBlacklistedEmail");
      }
      // verify the required parameter 'address' is set
      if (address === undefined || address === null) {
        throw new Error("Missing the required parameter 'address' when calling addUserBlacklistedEmail");
      }
     ...
     */
    addUserBlacklistedEmail(id, address) {
      return this.addUserBlacklistedEmailWithHttpInfo(id, address)
        .then(function(response_and_data) {
          return response_and_data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Object} and HTTP response
     */
    getUserBlacklistedEmailsWithHttpInfo(id) {
      const opts = {}
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getUserBlacklistedEmails");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Object}
     */
    getUserBlacklistedEmails(id) {
      return this.getUserBlacklistedEmailsWithHttpInfo(id)
        .then(function(response_and_data) {
          return response_and_data;
        });
    }
