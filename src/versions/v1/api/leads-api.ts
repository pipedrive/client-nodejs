...
export const LeadsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async addLead(AddLeadRequest?: AddLeadRequest, ): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<GetLeadResponse>> {
         ...
         * @throws {RequiredError}
         */
        async deleteLead(id: string, ): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<GetLeadIdResponse>> {
         ...
         * @throws {RequiredError}
         */
        async getLead(id: string, ): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<GetLeadResponse>> {
         ...
         * @throws {RequiredError}
         */
        async updateLead(id: string, UpdateLeadRequest?: UpdateLeadRequest, ): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<GetLeadResponse>> {
