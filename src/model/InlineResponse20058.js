    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = InlineResponse20058Data.constructFromObject(data['data']);
            }
        }
        return obj;
    }
 ...
 */
InlineResponse20058.prototype['success'] = undefined;

/**
 * @member {module:model/InlineResponse20058Data} data
 */
