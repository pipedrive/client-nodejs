...
import DeleteStagesResponseData from './DeleteStagesResponseData';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = DeleteStagesResponseData.constructFromObject(data['data']);
...
export default DeleteStagesResponse;
