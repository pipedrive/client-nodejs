...
/**
 * The AddAProductAllOf model module.
 * @module model/AddAProductAllOf
 * @version 1.0.0
 */
class AddAProductAllOf {
    /**
     * Constructs a new <code>AddAProductAllOf</code>.
     * @alias module:model/AddAProductAllOf
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>AddAProductAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddAProductAllOf} obj Optional instance to populate.
     * @return {module:model/AddAProductAllOf} The populated <code>AddAProductAllOf</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddAProductAllOf();
...
export default AddAProductAllOf;
