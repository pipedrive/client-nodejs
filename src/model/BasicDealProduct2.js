...
/**
 * The BasicDealProduct2 model module.
 * @module model/BasicDealProduct2
 * @version 1.0.0
 */
class BasicDealProduct2 {
    /**
     * Constructs a new <code>BasicDealProduct2</code>.
     * @alias module:model/BasicDealProduct2
     */
    constructor() { 
        
        BasicDealProduct2.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BasicDealProduct2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BasicDealProduct2} obj Optional instance to populate.
     * @return {module:model/BasicDealProduct2} The populated <code>BasicDealProduct2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BasicDealProduct2();
...
export default BasicDealProduct2;
