...
/**
 * The NoteOtherParams model module.
 * @module model/NoteOtherParams
 * @version 1.0.0
 */
class NoteOtherParams {
    /**
     * Constructs a new <code>NoteOtherParams</code>.
     * @alias module:model/NoteOtherParams
     */
    constructor() { 
        
        NoteOtherParams.initialize(this);
    }
    ...
    /**
     * Constructs a <code>NoteOtherParams</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NoteOtherParams} obj Optional instance to populate.
     * @return {module:model/NoteOtherParams} The populated <code>NoteOtherParams</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NoteOtherParams();
 ...
 */
NoteOtherParams.prototype['add_time'] = undefined;
 ...
 */
NoteOtherParams.prototype['pinned_to_lead_flag'] = undefined;
 ...
 */
NoteOtherParams.prototype['pinned_to_deal_flag'] = undefined;
 ...
 */
NoteOtherParams.prototype['pinned_to_organization_flag'] = undefined;
 ...
 */
NoteOtherParams.prototype['pinned_to_person_flag'] = undefined;
...
export default NoteOtherParams;
