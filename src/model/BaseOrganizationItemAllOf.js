...
/**
 * The BaseOrganizationItemAllOf model module.
 * @module model/BaseOrganizationItemAllOf
 * @version 1.0.0
 */
class BaseOrganizationItemAllOf {
    /**
     * Constructs a new <code>BaseOrganizationItemAllOf</code>.
     * @alias module:model/BaseOrganizationItemAllOf
     */
    constructor() { 
        
        BaseOrganizationItemAllOf.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BaseOrganizationItemAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BaseOrganizationItemAllOf} obj Optional instance to populate.
     * @return {module:model/BaseOrganizationItemAllOf} The populated <code>BaseOrganizationItemAllOf</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BaseOrganizationItemAllOf();
...
export default BaseOrganizationItemAllOf;
