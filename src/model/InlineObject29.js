...
class InlineObject29 {
     ...
     * @param eventAction {module:model/InlineObject29.EventActionEnum} Type of action to receive notifications about. Wildcard will match all supported actions.
     * @param eventObject {module:model/InlineObject29.EventObjectEnum} Type of object to receive notifications about. Wildcard will match all supported objects.
     */
    constructor(subscriptionUrl, eventAction, eventObject) { 
        
        InlineObject29.initialize(this, subscriptionUrl, eventAction, eventObject);
    }
 ...
 */
InlineObject29.prototype['subscription_url'] = undefined;

/**
 * Type of action to receive notifications about. Wildcard will match all supported actions.
 * @member {module:model/InlineObject29.EventActionEnum} event_action
 */
InlineObject29.prototype['event_action'] = undefined;

/**
 * Type of object to receive notifications about. Wildcard will match all supported objects.
 * @member {module:model/InlineObject29.EventObjectEnum} event_object
 */
InlineObject29.prototype['event_object'] = undefined;
 ...
 * @readonly
 */
InlineObject29['EventActionEnum'] = {
 ...
 * @readonly
 */
InlineObject29['EventObjectEnum'] = {
