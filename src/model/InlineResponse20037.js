    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = InlineResponse20036Data.constructFromObject(data['data']);
            }
        }
        return obj;
    }
 ...
 */
InlineResponse20037.prototype['success'] = undefined;

/**
 * @member {module:model/InlineResponse20036Data} data
 */
