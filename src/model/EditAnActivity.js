...
import EditAnActivityAllOf from './EditAnActivityAllOf';

/**
 * The EditAnActivity model module.
 * @module model/EditAnActivity
 * @version 1.0.0
 */
class EditAnActivity {
    /**
     * Constructs a new <code>EditAnActivity</code>.
     * @alias module:model/EditAnActivity
     * @implements module:model/AddAnActivityAllOf
     * @implements module:model/EditAnActivityAllOf
     */
    constructor() { 
        AddAnActivityAllOf.initialize(this);EditAnActivityAllOf.initialize(this);
        EditAnActivity.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EditAnActivity</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EditAnActivity} obj Optional instance to populate.
     * @return {module:model/EditAnActivity} The populated <code>EditAnActivity</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EditAnActivity();
            AddAnActivityAllOf.constructFromObject(data, obj);
            EditAnActivityAllOf.constructFromObject(data, obj);
 ...
 */
EditAnActivity.prototype['public_description'] = undefined;

/**
 * Subject of the Activity
 * @member {String} subject
 */
EditAnActivity.prototype['subject'] = undefined;

/**
 * Type of the Activity. This is in correlation with the key_string parameter of ActivityTypes.
 * @member {String} type
 */
EditAnActivity.prototype['type'] = undefined;

/**
 * The ID of the User whom the Activity is assigned to
 * @member {Number} user_id
 */
EditAnActivity.prototype['user_id'] = undefined;
 ...
 */
EditAnActivity.prototype['participants'] = undefined;
 ...
 * @member {module:model/EditAnActivity.BusyFlagEnum} busy_flag
 */
EditAnActivity.prototype['busy_flag'] = undefined;
 ...
 */
EditAnActivity.prototype['attendees'] = undefined;

/**
 * @member {Number} done
 */
EditAnActivity.prototype['done'] = undefined;
...
// Implement EditAnActivityAllOf interface:
/**
 * Subject of the Activity
 * @member {String} subject
 */
EditAnActivityAllOf.prototype['subject'] = undefined;
/**
 * Type of the Activity. This is in correlation with the key_string parameter of ActivityTypes.
 * @member {String} type
 */
EditAnActivityAllOf.prototype['type'] = undefined;
/**
 * The ID of the User whom the Activity is assigned to
 * @member {Number} user_id
 */
EditAnActivityAllOf.prototype['user_id'] = undefined;
/**
 * List of multiple Persons (participants) this Activity is associated with. It requires a structure as follows: [{\"person_id\":1,\"primary_flag\":true}]
 * @member {Array.<Object>} participants
 */
EditAnActivityAllOf.prototype['participants'] = undefined;
/**
 * Set the Activity as 'Busy' or 'Free'. If the flag is set to true, your customers will not be able to book that time slot through any Scheduler links. The flag can also be unset by never setting it or overriding it with null. When the value of the flag is unset (null), the flag defaults to 'Busy' if it has a time set, and 'Free' if it is an all-day event without specified time.
 * @member {module:model/EditAnActivityAllOf.BusyFlagEnum} busy_flag
 */
EditAnActivityAllOf.prototype['busy_flag'] = undefined;
/**
 * Attendees of the Activity. This can be either your existing Pipedrive contacts or an external email address. It requires a structure as follows: [{\"email_address\":\"mail@example.org\"}] or [{\"person_id\":1, \"email_address\":\"mail@example.org\"}]
 * @member {Array.<Object>} attendees
 */
EditAnActivityAllOf.prototype['attendees'] = undefined;
/**
 * @member {Number} done
 */
EditAnActivityAllOf.prototype['done'] = undefined;
