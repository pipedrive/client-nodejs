...
/**
 * The AddAProductToTheDealAllOf model module.
 * @module model/AddAProductToTheDealAllOf
 * @version 1.0.0
 */
class AddAProductToTheDealAllOf {
    /**
     * Constructs a new <code>AddAProductToTheDealAllOf</code>.
     * @alias module:model/AddAProductToTheDealAllOf
     */
    constructor() { 
        
        AddAProductToTheDealAllOf.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddAProductToTheDealAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddAProductToTheDealAllOf} obj Optional instance to populate.
     * @return {module:model/AddAProductToTheDealAllOf} The populated <code>AddAProductToTheDealAllOf</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddAProductToTheDealAllOf();
...
export default AddAProductToTheDealAllOf;
