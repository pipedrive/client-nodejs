...
/**
 * The EditAnActivityAllOf model module.
 * @module model/EditAnActivityAllOf
 * @version 1.0.0
 */
class EditAnActivityAllOf {
    /**
     * Constructs a new <code>EditAnActivityAllOf</code>.
     * @alias module:model/EditAnActivityAllOf
     */
    constructor() { 
        
        EditAnActivityAllOf.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EditAnActivityAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EditAnActivityAllOf} obj Optional instance to populate.
     * @return {module:model/EditAnActivityAllOf} The populated <code>EditAnActivityAllOf</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EditAnActivityAllOf();
 ...
 * @readonly
 */
EditAnActivityAllOf['BusyFlagEnum'] = {
...
export default EditAnActivityAllOf;
