...
let opts = {
  ...
  'dealId': 56, // Number | ID of the deal the note will be attached to.
  'personId': 56, // Number | ID of the person this note will be attached to.
  'orgId': 56, // Number | ID of the organization this note will be attached to.
...
let apiInstance = new Pipedrive.NotesApi();
let opts = {
  'userId': 56, // Number | ID of the user whose notes to fetch. If omitted, notes by all users will be returned.
  'dealId': 56, // Number | ID of the deal which notes to fetch. If omitted, notes about all deals with be returned.
  'personId': 56, // Number | ID of the person whose notes to fetch. If omitted, notes about all persons with be returned.
  'orgId': 56, // Number | ID of the organization which notes to fetch. If omitted, notes about all organizations with be returned.
  ...
  'startDate': new Date("2013-10-20"), // Date | Date in format of YYYY-MM-DD from which notes to fetch from.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **userId** | **Number**| ID of the user whose notes to fetch. If omitted, notes by all users will be returned. | [optional] 
 **dealId** | **Number**| ID of the deal which notes to fetch. If omitted, notes about all deals with be returned. | [optional] 
 **personId** | **Number**| ID of the person whose notes to fetch. If omitted, notes about all persons with be returned. | [optional] 
 **orgId** | **Number**| ID of the organization which notes to fetch. If omitted, notes about all organizations with be returned. | [optional] 
 ...
 **startDate** | **Date**| Date in format of YYYY-MM-DD from which notes to fetch from. | [optional] 
