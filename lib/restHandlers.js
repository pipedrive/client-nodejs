(function () {
	...
	RestHandlers.prototype.listItems = function (object, params, callback) {
		var self = this,
			...
			dataObject = object == 'authorizations' ? {
				multipart: false,
				data: paramsToSupply
			} : {query: qs.stringify(paramsToSupply)},
			req = rest[object == 'authorizations' ? 'post' : 'get'](
				apiUrl(object, this.options, false),
				_.extend({userAgent: this.options.userAgent}, dataObject)
			);
	...
	RestHandlers.prototype.findItems = function (object, params, callback) {
		var self = this,
			...
			req = rest.get(
				apiUrl(object + '/find', this.options, false),
				_.extend({userAgent: this.options.userAgent}, dataObject)
			);
	...
	RestHandlers.prototype.timelineItems = function (object, params, callback) {
		var self = this,
			...
			dataObject = {query: qs.stringify(paramsToSupply)},
			req = rest.get(
				apiUrl(object + '/timeline', this.options, false),
				_.extend({userAgent: this.options.userAgent}, dataObject)
			);
	...
	RestHandlers.prototype.searchFields = function (object, params, callback) {
		var self = this,
			...
			dataObject = {query: qs.stringify(paramsToSupply)},
			req = rest.get(
				apiUrl(object + '/field', this.options, false),
				_.extend({userAgent: this.options.userAgent}, dataObject)
			);
	...
	RestHandlers.prototype.getItem = function (object, id, callback, params) {
		var self = this,
			paramsToSupply = _.extend({}, _.isObject(params) ? params : {}, this.options.apiToken ? {api_token: this.options.apiToken} : {}),
			req = rest.get(
				apiUrl(object + '/' + id, this.options, false),
				_.extend({userAgent: this.options.userAgent}, {
					json: true,
					query: qs.stringify(paramsToSupply)
				})
			);
	...
	RestHandlers.prototype.addItem = function (object, params, callback) {
		var self = this,
			...
			req = rest.post(
				apiUrl(object, this.options, true),
				_.extend({userAgent: this.options.userAgent}, {json: true, multipart: multipart, data: params})
			);
	...
	RestHandlers.prototype.editItem = function (itemId, object, params, callback) {
		var self = this,
			req = rest.put(
				apiUrl(object + '/' + itemId, this.options, true),
				_.extend({userAgent: this.options.userAgent}, {
					json: true,
					multipart: false,
					data: params
	...
	RestHandlers.prototype.removeItem = function (itemId, object, params, callback) {
		var self = this,
			req = rest.del(
				apiUrl(itemId ? object + '/' + itemId : object, this.options, true),
				_.extend({userAgent: this.options.userAgent}, {
					json: true,
					multipart: false,
					data: (_.isObject(params) && !_.isFunction(params) ? params : {id: itemId})
				})
			);
		...
		var self = this,
			req = rest.del(
				...
				_.extend({userAgent: this.options.userAgent}, {
					json: true,
					multipart: false,
					data: (_.isObject(params) && !_.isFunction(params) ? params : {ids: itemIds})
				})
			);
	...
	RestHandlers.prototype.mergeItem = function (whichId, withId, object, callback) {
		...
		var self = this,
			req = rest.post(apiUrl(object + '/' + whichId + '/merge', this.options, true),
				_.extend({userAgent: this.options.userAgent}, {
					json: true,
					multipart: false,
					data: {merge_with_id: withId}
				})
			);
	...
	RestHandlers.prototype.duplicateItem = function (whichId, object, callback) {
		...
		var self = this,
			req = rest.post(apiUrl(object + '/' + whichId + '/duplicate', this.options, true),
				_.extend({userAgent: this.options.userAgent}, {
					json: true,
					multipart: false,
					data: {}
