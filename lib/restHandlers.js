(function() {
	...
	function RestHandlers(options, apiToken) {
		var defaults = {
			apiToken: apiToken
		};
	...
	RestHandlers.prototype.addItem = function(object, params, callback) {
		...
		var that = this,
			req = rest.post(apiUrl(object, this.options.apiToken, true), { json: true, multipart: multipart, data: params });
	...
	RestHandlers.prototype.editItem = function(itemId, object, params, callback) {
		var that = this,
			req = rest.put(apiUrl(object + '/' + itemId, this.options.apiToken, true), { json: true, multipart: false, data: params });
	...
	RestHandlers.prototype.removeItem = function(itemId, object, params, callback) {
		var that = this,
			req = rest.del(apiUrl(itemId ? object + '/' + itemId : object, this.options.apiToken, true), { json: true, multipart: false, data: (_.isObject(params) && !_.isFunction(params) ? params : { id: itemId }) });
	...
	RestHandlers.prototype.removeManyItems = function(itemIds, object, params, callback) {
		var that = this,
			req = rest.del(apiUrl(object, this.options.apiToken, true), { json: true, multipart: false, data: (_.isObject(params) && !_.isFunction(params) ? params : { ids: itemIds }) });
	...
	RestHandlers.prototype.mergeItem = function(whichId, withId, object, callback) {
		...
		var that = this,
			req = rest.post(apiUrl(object + '/' + whichId + '/merge', this.options.apiToken, true), { json: true, multipart: false, data: { merge_with_id: withId } });
	...
	RestHandlers.prototype.duplicateItem = function(whichId, object, callback) {
		...
		var that = this,
			req = rest.post(apiUrl(object + '/' + whichId + '/duplicate', this.options.apiToken, true), { json: true, multipart: false, data: {} });
