(function() {
	...
	module.exports = function RestHandlers(options) {
		var defaults = {
			apiToken: null
		};
	...
	RestHandlers.prototype.listItems = function(object, params, callback) {
		var paramsToSupply = _.extend({}, _.isObject(params) ? params : {}, this.options.apiToken ? { api_token: this.options.apiToken } : {}),
			...
			req = rest[object == 'authorizations' ? 'post' : 'get'](apiUrl(object, this.options.apiToken, false), dataObject);

		req.on('complete', function(data, res) {
			genericResponse('GET', object, data, callback, req, res);
		});
	...
	RestHandlers.prototype.findItems = function(object, params, callback) {
		var paramsToSupply = _.extend({}, _.isObject(params) ? params : {}, this.options.apiToken ? { api_token: this.options.apiToken } : {}),
			...
			req = rest.get(apiUrl(object + '/find', this.options.apiToken, false), dataObject);
	...
	RestHandlers.prototype.timelineItems = function(object, params, callback) {
		var paramsToSupply = _.extend({}, _.isObject(params) ? params : {}, this.options.apiToken ? { api_token: this.options.apiToken } : {}),
			dataObject = { query: qs.stringify(paramsToSupply) },
			req = rest.get(apiUrl(object + '/timeline', this.options.apiToken, false), dataObject);
	...
	RestHandlers.prototype.searchFields = function(object, params, callback) {
		var paramsToSupply = _.extend({}, _.isObject(params) ? params : {}, this.options.apiToken ? { api_token: this.options.apiToken } : {}),
			dataObject = { query: qs.stringify(paramsToSupply) },
			req = rest.get(apiUrl(object + '/field', this.options.apiToken, false), dataObject);
	...
	RestHandlers.prototype.getItem = function(object, id, callback, params) {
		var paramsToSupply = _.extend({}, _.isObject(params) ? params : {}, this.options.apiToken ? { api_token: this.options.apiToken } : {}),
			req = rest.get(apiUrl(object + '/' + id, this.options.apiToken, false), { json: true, query: qs.stringify(paramsToSupply) });
	...
	RestHandlers.prototype.addItem = function(object, params, callback) {
		...
		var req = rest.post(apiUrl(object, this.options.apiToken, true), { json: true, multipart: multipart, data: params });

		req.on('complete', function(data, res) {
			genericResponse('POST', object, data, callback, req, res);
		});
	...
	RestHandlers.prototype.editItem = function(itemId, object, params, callback) {
		var req = rest.put(apiUrl(object + '/' + itemId, this.options.apiToken, true), { json: true, multipart: false, data: params });

		req.on('complete', function(data, res) {
			genericResponse('PUT', object, data, callback, req, res);
		});
	...
	RestHandlers.prototype.removeItem = function(itemId, object, params, callback) {
		var req = rest.del(apiUrl(itemId ? object + '/' + itemId : object, this.options.apiToken, true), { json: true, multipart: false, data: (_.isObject(params) && !_.isFunction(params) ? params : { id: itemId }) });

		req.on('complete', function(data, res) {
			genericResponse('DELETE', object, data, (_.isFunction(params) ? params : callback), req, res);
		});
	...
	RestHandlers.prototype.removeManyItems = function(itemIds, object, params, callback) {
		var req = rest.del(apiUrl(object, this.options.apiToken, true), { json: true, multipart: false, data: (_.isObject(params) && !_.isFunction(params) ? params : { ids: itemIds }) });
	...
	RestHandlers.prototype.mergeItem = function(whichId, withId, object, callback) {
		...
		var req = rest.post(apiUrl(object + '/' + whichId + '/merge', this.options.apiToken, true), { json: true, multipart: false, data: { merge_with_id: withId } });
	...
	RestHandlers.prototype.duplicateItem = function(whichId, object, callback) {
		...
		var req = rest.post(apiUrl(object + '/' + whichId + '/duplicate', this.options.apiToken, true), { json: true, multipart: false, data: {} });
