(function() {
	...
	RestHandlers.prototype.listItems = function(object, params, callback) {
        let self = this;
		let	paramsToSupply = _.extend({}, _.isObject(params) ? params : {}, this.options.apiToken ? { api_token: this.options.apiToken } : {});
		let	dataObject = object === 'authorizations' ? { multipart: false, data: paramsToSupply } : { query: qs.stringify(paramsToSupply), oauth_token: this.options.apiToken};

        let requestUrl = apiUrl(object, this.options, false);
        let	req = rest[object === 'authorizations' ? 'post' : 'get'](requestUrl, dataObject);
	...
	RestHandlers.prototype.findItems = function(object, params, callback) {
		let self = this;
		let paramsToSupply = _.extend({}, _.isObject(params) ? params : {}, this.options.apiToken ? { api_token: this.options.apiToken } : {});
		let dataObject = { query: qs.stringify(paramsToSupply), oauth_token: this.options.apiToken };
        let req = rest.get(apiUrl(object + '/find', this.options, false), dataObject);
		req.on('complete', function(data, res) {
			self.genericResponse('GET', object, data, callback, req, res);
		});
	...
	RestHandlers.prototype.timelineItems = function(object, params, callback) {
		var self = this,
			...
			dataObject = { query: qs.stringify(paramsToSupply), oauth_token: this.options.apiToken },
	...
	RestHandlers.prototype.getItem = function(object, id, callback, params) {
		var self = this,
			paramsToSupply = _.extend({}, _.isObject(params) ? params : {}, this.options.apiToken ? { api_token: this.options.apiToken } : {}),
			req = rest.get(apiUrl(object + '/' + id, this.options, false), { json: true, query: qs.stringify(paramsToSupply), oauth_token: this.options.apiToken });
	...
	RestHandlers.prototype.addItem = function(object, params, callback) {
		var self = this,
			...
			req = rest.post(apiUrl(object, this.options, true), { json: true, multipart: multipart, data: params, oauth_token: this.options.apiToken });
	...
	RestHandlers.prototype.editItem = function(itemId, object, params, callback) {
		var self = this,
			req = rest.put(apiUrl(object + '/' + itemId, this.options, true), { json: true, multipart: false, data: params, oauth_token: this.options.apiToken });
	...
	RestHandlers.prototype.removeItem = function(itemId, object, params, callback) {
		var self = this,
			req = rest.del(apiUrl(itemId ? object + '/' + itemId : object, this.options, true), { json: true, multipart: false, data: (_.isObject(params) && !_.isFunction(params) ? params : { id: itemId }), oauth_token: this.options.apiToken });
	...
	RestHandlers.prototype.removeManyItems = function(itemIds, object, params, callback) {
        ...
        let self = this;
		let req = rest.del(apiUrl(object, this.options, true), { json: true, multipart: false, data: (_.isObject(params) && !_.isFunction(params) ? params : { ids: itemIds }), query: qs.stringify({ids: ids}), oauth_token: this.options.apiToken });
	...
	RestHandlers.prototype.mergeItem = function(whichId, withId, object, callback) {
		...
		var self = this,
			req = rest.post(apiUrl(object + '/' + whichId + '/merge', this.options, true), { json: true, multipart: false, data: { merge_with_id: withId }, oauth_token: this.options.apiToken });
	...
	RestHandlers.prototype.duplicateItem = function(whichId, object, callback) {
		...
		var self = this,
			req = rest.post(apiUrl(object + '/' + whichId + '/duplicate', this.options, true), { json: true, multipart: false, data: {}, oauth_token: this.options.apiToken });
