...
class PersonsController {
     ...
     * @param {boolean} input['exact_match'] Full exact matches against the given term.
     * @param {int} input['organization_id'] Filter Deals by the provided Organization ID.
     * @param {string} input['include_fields'] Supports including optional fields.
     * @param {double} input['start'] (optional) Pagination start
     * @param {double} input['limit'] (optional) Items shown per page
     *
     * @callback    The callback function that returns response from the API call
