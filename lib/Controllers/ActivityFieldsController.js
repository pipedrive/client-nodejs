...
class ActivityFieldsController {
     ...
     * @returns {Promise}
     */
    static getAllFieldsForAnActivity(callback) {
        ...
        if (_oAuthManager.isTokenSet()) {
            return ActivityFieldsController.getAllFieldsForAnActivityAction(_queryUrl, _callback);
        }
        return _oAuthManager.authorize().then(
            () => ActivityFieldsController.getAllFieldsForAnActivityAction(_queryUrl, _callback),
            (err) => {
                _callback(err, null, null);
                return Promise.reject(err);
            });
    }
    static getAllFieldsForAnActivityAction(_queryUrl, _callback) {
...
module.exports = ActivityFieldsController;
