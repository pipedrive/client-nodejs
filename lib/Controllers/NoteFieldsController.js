...
class NoteFieldsController {
     ...
     * @returns {Promise}
     */
    static getAllFieldsForANote(callback) {
        ...
        if (_oAuthManager.isTokenSet()) {
            return NoteFieldsController.getAllFieldsForANoteAction(_queryUrl, _callback);
        }
        return _oAuthManager.authorize().then(
            () => NoteFieldsController.getAllFieldsForANoteAction(_queryUrl, _callback),
            (err) => {
                _callback(err, null, null);
                return Promise.reject(err);
            });
    }
    static getAllFieldsForANoteAction(_queryUrl, _callback) {
...
module.exports = NoteFieldsController;
