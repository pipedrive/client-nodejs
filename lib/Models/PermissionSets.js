...
/**
 * Creates an instance of PermissionSets
 */
class PermissionSets extends BaseModel {
    /**
     * @constructor
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'data', realName: 'data', array: true, type: 'PermissionSetsItem' },
        ]);
    }
