...
/**
 * Creates an instance of GetNotes
 */
class GetNotes extends BaseModel {
    /**
     * @constructor
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'data', realName: 'data', array: true, type: 'BaseNote' },
            { name: 'additional_data', realName: 'additional_data', type: 'AdditionalData' },
        ]);
    }
