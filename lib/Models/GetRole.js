...
/**
 * Creates an instance of GetRole
 */
class GetRole extends BaseModel {
    /**
     * @constructor
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'data', realName: 'data', type: 'SubRole' },
            { name: 'additional_data', realName: 'additional_data', type: 'AdditionalData3' },
        ]);
    }
