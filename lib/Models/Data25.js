...
/**
 * Creates an instance of Data25
 */
class Data25 extends BaseModel {
    /**
     * @constructor
    ...
    constructor(obj) {
        ...
        this.average_time_to_won = this.constructor.getValue(obj.average_time_to_won);
        this.average_stage_progress = this.constructor.getValue(obj.average_stage_progress);
        this.age = this.constructor.getValue(obj.age);
        this.stay_in_pipeline_stages = this.constructor.getValue(obj.stay_in_pipeline_stages);
        this.last_activity = this.constructor.getValue(obj.last_activity);
        this.next_activity = this.constructor.getValue(obj.next_activity);
    }
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'person_hidden', realName: 'person_hidden' },
            {
                ...
                realName: 'average_time_to_won',
                type: 'AverageTimeToWon',
            },
            { name: 'average_stage_progress', realName: 'average_stage_progress' },
            { name: 'age', realName: 'age', type: 'Age' },
            {
                name: 'stay_in_pipeline_stages',
                realName: 'stay_in_pipeline_stages',
                type: 'StayInPipelineStages',
            },
            { name: 'last_activity', realName: 'last_activity' },
            { name: 'next_activity', realName: 'next_activity' },
        ]);
    }
