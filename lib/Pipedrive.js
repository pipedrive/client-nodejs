...
(function () {
	...
	exports.OAuthAuthenticate = (client_id, redirect_uri, res) => {
	...
	exports.OAuthAuthenticateCallback = (req, res, redirect_uri, clientId, clientSecret) => {
	...
	exports.OAuthRefreshToken = (req, res, refresh_token, clientId, clientSecret) => {
	    let refreshOptions = {
	        url: 'https://oauth.pipedrive.com/oauth/token',
            form: {
	            refresh_token,
