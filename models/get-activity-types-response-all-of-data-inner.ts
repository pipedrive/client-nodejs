 ...
 * 
 * @export
 * @interface GetActivityTypesResponseAllOfDataInner
 */
export interface GetActivityTypesResponseAllOfDataInner {
    /**
     * The ID of the activity type
     * @type {number}
     * @memberof GetActivityTypesResponseAllOfDataInner
     */
    'id'?: number;
    /**
     ...
     * @memberof GetActivityTypesResponseAllOfDataInner
     */
    'icon_key'?: GetActivityTypesResponseAllOfDataInnerIconKeyConst;
    /**
...
export const GetActivityTypesResponseAllOfDataInnerIconKeyConst = {
    task: 'task',
    email: 'email',
    meeting: 'meeting',
    deadline: 'deadline',
...
export type GetActivityTypesResponseAllOfDataInnerIconKeyConst = typeof GetActivityTypesResponseAllOfDataInnerIconKeyConst[keyof typeof GetActivityTypesResponseAllOfDataInnerIconKeyConst];
